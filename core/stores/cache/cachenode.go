...
func (c cacheNode) doGetCache2(ctx context.Context, key string, p *redis.StringCmd, cacheF func(k, v string) (interface{}, error)) error {
	c.stat.IncrementTotal()
	data, err := p.Result()
	if err == redis.Nil {
		err = nil
...
func (c cacheNode) processCache2(ctx context.Context, key, data string, cacheF func(k, v string) (interface{}, error)) error {
